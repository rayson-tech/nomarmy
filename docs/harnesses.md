...
| [mock-oidc](https://github.com/rayson-tech/nomarmy/blob/main/harnesses/mock-oidc/README.md) | Mock OAuth2 and OIDC discovery and login on an isolated verification network | none | services | none |
