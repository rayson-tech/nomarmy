...
// Whether the entry's model supports a thinking/reasoning mode -- mirrors
// config/common.env's NOMARMY_MODEL_THINKING for the single-provider case,
// per pool entry, since a pool can mix models that do and don't.
const thinkingSchema = z.boolean().default(true);
