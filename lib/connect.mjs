 ...
 */
export function derivePoolAuthEnvPlaceholders(nomarmyRoot) {
  let loaded;
  try {
...
export function connectClaude({ nomarmyRoot, installDir = defaultInstallDir(), run = defaultRun, extraEnv = {} }) {
  ...
  const finalEnv = { ...derivePoolAuthEnvPlaceholders(nomarmyRoot), ...preservedEnv, ...extraEnv, ...deriveWorkerModelEnv(nomarmyRoot) };
